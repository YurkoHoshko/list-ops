defmodule ListOpsTest do
  ...
  test "count of non-list" do
    assert_raise(FunctionClauseError, fn -> L.count(1) end)
  end
  ...
  test "reverse of non-list" do
    assert_raise(FunctionClauseError, fn -> L.reverse(1) end)
  end
  ...
  test "map of non-list" do
    assert_raise(FunctionClauseError, fn -> L.map(1, &(&1)) end)
  end
  ...
  test "filter of non-list" do
    assert_raise(FunctionClauseError, fn -> L.filter(1, fn(_v) -> true end) end)
  end
  ...
  test "reduce of non-list" do
    assert_raise(FunctionClauseError, fn -> L.reduce(1, 0, fn(_v) -> true end) end)
  end
  ...
  test "append of non-list and list" do
    assert_raise(FunctionClauseError, fn -> L.append(1, []) end)
  end

  test "append of list and non-list" do
    assert_raise(FunctionClauseError, fn -> L.append([], 1) end)
  end
  ...
  test "concat of list and non-lists" do
    assert_raise(FunctionClauseError, fn -> L.concat([[], 1]) end)
  end
end
